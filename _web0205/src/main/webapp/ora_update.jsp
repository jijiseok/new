...
String sql = "update score2 set name=? , kor=?, eng=? , math=? where num=?"; //oracle에 입력할 문자열 
PreparedStatement pstmt = conn.prepareStatement(sql); //문자열에 들어갈것들을 준비한다
pstmt.setString(5, request.getParameter("num")); //""안에는 form에 있는거와 같아야한다
...
response.sendRedirect("ora_list.jsp");
