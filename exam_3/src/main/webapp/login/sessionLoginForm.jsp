...
<main class="form-signin w-100 m-auto">
  <form action="<%= request.getContextPath() %>/login/sessionLogin.jsp"
    ...
    <div class="form-floating">
      <input type="email" name="password" class="form-control" id="floatingPassword" placeholder="이메일">
...
<div class="mb-3">
    ...
    <div>
      <a href="<%= request.getContextPath() %>/login/sessionJoinForm.jsp" class="btn btn-primary w-100 py-2">회원가입</a>
    </div>
